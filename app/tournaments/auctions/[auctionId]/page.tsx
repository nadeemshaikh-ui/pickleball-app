  ...
  return (
    <main className="page">
      <div className="page-header-row">
        <Link href="/tournaments/auctions" className="text-link-btn">← Auctions</Link>
      </div>
      ...
      <div className="card" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
        ...
        {auction.status === 'active' && (
          <Link href={`/tournaments/auctions/${auctionId}/bid`} className="btn-primary">
            Go to Live Bidding
          </Link>
        )}
        <Link href={`/tournaments/auctions/${auctionId}/rosters`} className="btn-secondary">
          Final Rosters
        </Link>
      </div>
